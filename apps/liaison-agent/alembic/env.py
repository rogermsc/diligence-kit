...
def include_object(object, name, type_, reflected, compare_to):
    """
    Filtra quais tabelas o Alembic deve considerar para autogeração.
    Retorna True se o objeto deve ser incluído, False caso contrário.
    """
    if type_ == "table":
        return name == "chat_messages"
