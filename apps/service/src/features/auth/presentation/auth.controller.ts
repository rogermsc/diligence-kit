...
import { RefreshTokenUseCase, RefreshTokenOutput } from '@/features/auth/use-case/refresh-token.usecase';
...
export class AuthController {
    ...
    async refreshToken(@Body() body: unknown): Promise<RefreshTokenOutput> {
        const validatedData = RequestValidator.validate(body, refreshTokenSchema);
