...
@Module({
  ...
  providers: [
    ...
    { provide: 'AutomationRepository', useClass: PrismaAutomationRepositoryAdapter },
    { provide: 'CompanyRepository', useClass: PrismaCompanyRepositoryAdapter },
    { provide: 'IResultRepository', useClass: PrismaResultRepositoryAdapter },
    { provide: 'DocumentRepository', useClass: PrismaDocumentRepositoryAdapter },
  ],
  exports: [],
})
