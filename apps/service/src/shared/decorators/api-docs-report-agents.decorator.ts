...
export const ApiTriggerSecondStage = () => {
    return applyDecorators(
        ApiOperation({ 
            ...
            description: 'Triggers the second stage (diligence) of an automation that has completed the triage stage'
        }),
        ApiParam({
            name: 'automationId',
            description: 'The UUID of the automation to trigger second stage for',
            type: 'string',
            format: 'uuid'
        }),
        ApiResponse({
        ...
        ApiResponse({
            ...
            schema: {
                type: 'object',
                properties: {
                    message: { type: 'string', example: 'Invalid automationId format.' }
                }
            }
        }),
        ApiResponse({
        ...
        ApiResponse({
            ...
            schema: {
                type: 'object',
                properties: {
                    message: { type: 'string', example: 'Cannot trigger second stage yet.' }
                }
            }
        }),
        ApiResponse({
