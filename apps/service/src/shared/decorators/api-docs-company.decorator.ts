        ...
        ApiBody({
            ...
            schema: {
                ...
                properties: {
                    ...
                    description: { type: 'string', example: 'A cutting-edge technology company' },
                    website: { type: 'string', example: 'https://www.techinnovations.com' },
...
export const ApiGetCompanyOnePager = () => {
    return applyDecorators(
        ApiOperation({
            ...
            description: 'Downloads the one-pager PDF file from the most recent completed triage automation'
        }),
        ApiParam({
            name: 'automationId',
        ...
        ApiResponse({ status: 401, description: 'Unauthorized' }),
        ApiResponse({ status: 404, description: 'Company or one-pager not found' })
    );
};
...
export const ApiDeleteCompany = () => {
    return applyDecorators(
        ApiOperation({
            ...
            description: 'Permanently delete a company and all related data (automations, documents, results, reports, one-pagers). Data in Qdrant and Cloud Storage will remain.'
        }),
        ApiParam({
            name: 'id',
        ...
        ApiResponse({
            ...
            schema: {
                ...
                properties: {
                    ...
                    message: { type: 'string', example: 'Company "Tech Innovations Inc." and all related data deleted successfully' }
                }
            }
        }),
        ApiResponse({ status: 401, description: 'Unauthorized' }),
