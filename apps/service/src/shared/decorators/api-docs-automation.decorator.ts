...
export const ApiStartAutomation = () => {
    return applyDecorators(
        ApiOperation({
            ...
            description:
                "Upload a ZIP file containing documents and start the automation process for a specific company. Supports chunked uploads for large files.",
        }),
            ...
            schema: {
                ...
                properties: {
                    file: {
                        ...
                        format: "binary",
                        description:
                            "ZIP file containing documents for analysis",
                    },
                    chunkNumber: {
                        type: "string",
                        description:
        ...
        ApiResponse({
            status: 201,
            description:
                "Automation started successfully (final chunk processed)",
            schema: {
                type: "object",
                properties: {
                    message: {
        ...
        ApiResponse({
            status: 409,
            description: "Company already has a processing automation",
        }),
