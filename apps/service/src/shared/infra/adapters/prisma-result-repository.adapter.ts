...
import {
    CreateResultWithDocumentsInput,
    CreateResultWithDocumentsOutput,
    IResultRepository,
    ResultCreateInput,
} from "@/features/automation/domain/repository/result-repository.interface"
...
export class PrismaResultRepositoryAdapter implements IResultRepository {
    ...
    async createResultWithDocuments(
        ...
        try {
            ...
            throw new DatabaseAccessError(
                "Failed to create result with documents",
            )
        }
    }
}
